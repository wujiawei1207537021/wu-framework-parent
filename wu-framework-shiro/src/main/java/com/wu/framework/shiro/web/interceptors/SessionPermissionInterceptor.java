...
@Slf4j
@ConditionalOnProperty(prefix = ShiroConfigConstant.SHIRO_PREFIX, name = "verification", havingValue = "SESSION")
public class SessionPermissionInterceptor extends ShiroHandlerInterceptorAbstract {


    private final ShiroProperties shiroProperties;
    private final UserDetailsService userDetailsService;

    public SessionPermissionInterceptor(ShiroProperties shiroProperties, UserDetailsService userDetailsService) {
