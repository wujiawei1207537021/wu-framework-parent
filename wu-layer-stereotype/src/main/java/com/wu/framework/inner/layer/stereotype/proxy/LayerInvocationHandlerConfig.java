...
public class LayerInvocationHandlerConfig implements InitializingBean {
    ...
    public LayerInvocationHandlerConfig(ConfigurableBeanFactory configurableBeanFactory,
                                        DefaultProxyMethodInvocationHandler defaultProxyMethodInvocationHandler, List<InvocationHandler> invocationHandlerList) {
