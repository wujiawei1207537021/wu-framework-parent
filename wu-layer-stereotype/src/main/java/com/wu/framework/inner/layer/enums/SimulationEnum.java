...
//            return getRandom().nextLong(length); jdk17
    ...
    STRING(String.class, new SimulationStrategy() {
        ...
        @Override
        public Object text(Integer length) {
            return NormalUsedString.DOUBLE_QUOTE + strategy(length) + NormalUsedString.DOUBLE_QUOTE;
        }
    }),
    /**
     * map
    ...
    public interface SimulationStrategy {
         ...
         **/
        default Object text() {
            return NormalUsedString.DOUBLE_QUOTE + text(null) + NormalUsedString.DOUBLE_QUOTE;
        }
