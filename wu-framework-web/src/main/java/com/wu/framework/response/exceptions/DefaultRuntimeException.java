...
public class DefaultRuntimeException extends RuntimeException {
    ...
    /**
     * Constructs a new runtime exception with the specified detail message put
     ...
     *                later retrieval by the {@link #getMessage()} method.
     */
    public DefaultRuntimeException(Integer code, String message) {
        super(message);
        this.code = code;
    }
     ...
     * @since 1.7
     */
    public DefaultRuntimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }

    public DefaultRuntimeException(Integer code) {
        this.code = code;
    }
}
