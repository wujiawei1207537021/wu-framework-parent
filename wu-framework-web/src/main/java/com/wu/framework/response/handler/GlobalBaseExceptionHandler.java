...
import com.wu.framework.response.exceptions.DefaultRuntimeException;
...
public class GlobalBaseExceptionHandler {
    ...
    public Result<?> defaultRuntimeException(Exception exception) {
        exception.printStackTrace();
        log.error(exception.getMessage());
        return ResultFactory.of(DefaultResultCode.INTERNAL_SERVER_ERROR.getCode(),exception.getMessage());
    }
