...
public class LazyOperationMethodUpdateAllById extends AbstractLazyOperationMethod {
    ...
    public LazyOperationMethodUpdateAllById(LazyOperationParameter lazyOperationParameter) {
    ...
    public PersistenceRepository doAnalyzePersistenceRepository(Object[] sourceParams) throws Exception {
        ...
        for (Object o : collection) {
            queryString += SQLConverter.updatePreparedStatementSQL(o) + " ; \n ";
        }
        PersistenceRepository persistenceRepository = PersistenceRepositoryFactory.create(lazyOperationParameter().getLazyOperationConfig());
