 ...
 * @see com.wu.framework.inner.lazy.database.expand.database.persistence.LazyBaseDQLOperation
 */
@Slf4j
@ConditionalOnBean(value = DataSource.class)
public class LazyDQLOperationProxy extends AbstractLazyOperationProxyRetryInvocationHandler implements InvocationHandler, InitializingBean {
    ...
    public LazyDQLOperationProxy(List<LazyDQLOperationMethod> lazyOperationDQLMethods, LazyDynamicAdapter lazyDynamicAdapter, LazyTranslationAdapter lazyTranslationAdapter) {
        this.lazyDynamicAdapter = lazyDynamicAdapter;
        this.lazyOperationDQLMethods = lazyOperationDQLMethods;
    ...
    public Object retryInvoke(Object proxy, Method method, Object[] args, int retryTime, Throwable throwable, boolean hasRetry) throws Throwable {
        ...
        if (null != mergedAnnotation) {
            ...
            boolean autoCommit;
            LazyOperationMethod lazyOperationMethod = LAZY_OPERATION_DQL_METHOD_MAP.get(mergedAnnotation.proxyClassName());
    ...
    public void afterPropertiesSet() throws Exception {
        lazyOperationDQLMethods.forEach(lazyOperationMethod -> LAZY_OPERATION_DQL_METHOD_MAP.put(lazyOperationMethod.getClass().getName(), lazyOperationMethod));
    }
