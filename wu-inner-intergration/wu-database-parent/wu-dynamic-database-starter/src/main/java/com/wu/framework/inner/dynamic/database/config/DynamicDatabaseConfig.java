...
//
//    public final Map<String, LazyDataSource> CUSTOM_DATA_SOURCE_MAP = new HashMap<>();
...
//                CUSTOM_DATA_SOURCE_MAP.put(stringDatabaseConfigEntry.getKey(), new SimpleLazyProxyDataSource(stringDatabaseConfigEntry.getValue()));
//            }
//        }
//
//    }
