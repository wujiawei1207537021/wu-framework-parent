package com.wu.framework.inner.lazy.database.datasource.proxy.connection;

import com.wu.framework.inner.lazy.database.datasource.proxy.audit.LazyAuditHolderAdapter;
import com.wu.framework.inner.lazy.database.datasource.proxy.jdbc.LazyCallableStatement;
import com.wu.framework.inner.lazy.database.datasource.proxy.jdbc.LazyPreparedStatement;
import com.wu.framework.inner.lazy.database.datasource.proxy.jdbc.LazyStatement;
 ...
 */
public class LazyDataSourceConnection implements Connection {
    ...
    public LazyDataSourceConnection(Connection targetConnection) {
    ...
    public Statement createStatement() throws SQLException {
        ...
        return new LazyStatement(statement);
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        lazySQLContext.setSql(sql);
        lazySQLContext.setBeginTime(System.currentTimeMillis());
        DynamicLazySQLContextHolder.push(lazySQLContext);
        return new LazyPreparedStatement(preparedStatement);
    }
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        return new LazyCallableStatement(callableStatement);
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        CallableStatement callableStatement = targetConnection.prepareCall(sql, resultSetType, resultSetConcurrency);
        return new LazyCallableStatement(callableStatement);
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        CallableStatement callableStatement = targetConnection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability);
        return new LazyCallableStatement(callableStatement);
    }
