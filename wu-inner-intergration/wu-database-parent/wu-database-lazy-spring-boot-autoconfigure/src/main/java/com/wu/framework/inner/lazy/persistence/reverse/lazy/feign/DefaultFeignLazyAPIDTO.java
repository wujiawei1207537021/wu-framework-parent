 ...
 */
public class DefaultFeignLazyAPIDTO extends DefaultAbstractJavaReverseEngineeringMethod {


    public DefaultFeignLazyAPIDTO(ReverseClassLazyTableEndpoint reverseClassLazyTableEndpoint, LazyOperationConfig.ReverseEngineering reverseEngineering) {
    ...
    protected String getPackage() {
        return String.format("package %s;", this.getReverseClassLazyTableEndpoint().getPackageName() + NormalUsedString.DOT + "api.dto") + NormalUsedString.NEWLINE + NormalUsedString.NEWLINE;
    }
