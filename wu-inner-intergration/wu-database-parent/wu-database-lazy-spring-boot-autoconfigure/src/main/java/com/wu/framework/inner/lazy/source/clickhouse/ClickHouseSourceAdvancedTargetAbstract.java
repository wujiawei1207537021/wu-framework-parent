...
public abstract class ClickHouseSourceAdvancedTargetAbstract extends SourceAdvancedAbstract implements SourceAdvanced {
    /**
     ...
     * @param clazz 需要解析的class
     * @return 表结构
     * @see LazyTableUtil#analyzeLazyTable(Class)
     */
    @Override
