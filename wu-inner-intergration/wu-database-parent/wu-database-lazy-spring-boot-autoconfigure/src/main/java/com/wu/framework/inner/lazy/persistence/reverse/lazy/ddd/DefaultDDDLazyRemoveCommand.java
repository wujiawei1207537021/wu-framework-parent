 ...
 */
public class DefaultDDDLazyRemoveCommand extends DefaultAbstractJavaReverseEngineeringMethod {


    public DefaultDDDLazyRemoveCommand(ReverseClassLazyTableEndpoint reverseClassLazyTableEndpoint, LazyOperationConfig.ReverseEngineering reverseEngineering) {
    ...
    public void initClassAnnotationPart() {
        ...
        if (reverseEngineering.isEnableSwagger()) {
            addClassAnnotationPart(String.format("@Schema(title = \"%s\",description = \"%s\")", tableEndpoint.getTableName() + "_remove_command", tableEndpoint.getComment()));
        }
    }
    ...
    public void initClassNamePart() {
        ...
        String commandName = String.format("%sRemoveCommand", tableEndpoint.getClassName());
    ...
    protected String getPackage() {
        ...
        return String.format("package %s;",
                tableEndpoint.getPackageName() + NormalUsedString.DOT + "application" + NormalUsedString.DOT + "command" + NormalUsedString.DOT + humpToDOT()) + NormalUsedString.NEWLINE + NormalUsedString.NEWLINE;
    }
