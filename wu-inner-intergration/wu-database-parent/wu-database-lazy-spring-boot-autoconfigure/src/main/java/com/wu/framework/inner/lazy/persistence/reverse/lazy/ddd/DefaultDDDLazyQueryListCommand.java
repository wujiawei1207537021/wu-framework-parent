 ...
 */
public class DefaultDDDLazyQueryListCommand extends DefaultAbstractJavaReverseEngineeringMethod {


    public DefaultDDDLazyQueryListCommand(ReverseClassLazyTableEndpoint reverseClassLazyTableEndpoint, LazyOperationConfig.ReverseEngineering reverseEngineering) {
    ...
    public void initClassAnnotationPart() {
        ...
        if (reverseEngineering.isEnableSwagger()) {
            addClassAnnotationPart(String.format("@Schema(title = \"%s\",description = \"%s\")", tableEndpoint.getTableName() + "_query_List_command", tableEndpoint.getComment()));
        }
    }
    ...
    public void initClassNamePart() {
        ...
        String commandName = String.format("%sQueryListCommand", tableEndpoint.getClassName());
