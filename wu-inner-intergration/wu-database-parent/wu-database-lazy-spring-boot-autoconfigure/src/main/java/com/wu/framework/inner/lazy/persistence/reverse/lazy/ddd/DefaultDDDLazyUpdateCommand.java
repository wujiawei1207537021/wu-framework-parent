 ...
 */
public class DefaultDDDLazyUpdateCommand extends DefaultAbstractJavaReverseEngineeringMethod {


    public DefaultDDDLazyUpdateCommand(ReverseClassLazyTableEndpoint reverseClassLazyTableEndpoint, LazyOperationConfig.ReverseEngineering reverseEngineering) {
    ...
    public void initClassAnnotationPart() {
        ...
        if (reverseEngineering.isEnableSwagger()) {
            addClassAnnotationPart(String.format("@Schema(title = \"%s\",description = \"%s\")", tableEndpoint.getTableName() + "_update_command", tableEndpoint.getComment()));
        }
    }
    ...
    public void initClassNamePart() {
        ...
        String commandName = String.format("%sUpdateCommand", tableEndpoint.getClassName());
    ...
    public void initClassFieldPart() {
        ...
        fieldEndpoints.stream().collect(
        ...
        ).forEach(fieldLazyTableFieldEndpoint -> {
            ...
            final MysqlColumnTypeEnum mysqlColumnTypeEnum = MysqlColumnTypeEnum.MYSQL_COLUMN_TYPE_ENUM_MAP.getOrDefault(fieldLazyTableFieldEndpoint.getDataType(), MysqlColumnTypeEnum.VARCHAR);
