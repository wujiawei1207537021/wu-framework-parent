package com.wu.framework.inner.database.expand.database.persistence.factory;
 ...
 * @author : Jia wei Wu
 * @version 1.0
 * @describe : 自动扫描包com.wu.framework.inner.database.expand.database.persistence.method 下面的class
...
public class LayerOperationMethodFactory implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        // 指定扫描的包名
        Set<BeanDefinition> candidateComponents = provider.findCandidateComponents("com.wu.framework.inner.database.expand.database.persistence.method");
