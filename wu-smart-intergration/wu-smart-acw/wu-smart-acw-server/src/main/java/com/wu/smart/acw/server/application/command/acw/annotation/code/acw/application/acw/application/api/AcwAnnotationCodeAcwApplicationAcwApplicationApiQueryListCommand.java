...
@Schema(title = "acw_annotation_code_acw_application_acw_application_api_query_List_command",description = "")
public class AcwAnnotationCodeAcwApplicationAcwApplicationApiQueryListCommand {
