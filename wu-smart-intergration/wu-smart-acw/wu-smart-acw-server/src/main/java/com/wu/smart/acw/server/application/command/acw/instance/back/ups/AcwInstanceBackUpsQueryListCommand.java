package com.wu.smart.acw.server.application.command.acw.instance.back.ups;
...
@Schema(title = "acw_instance_back_ups_query_List_command",description = "数据库实例备份信息")
public class AcwInstanceBackUpsQueryListCommand {
