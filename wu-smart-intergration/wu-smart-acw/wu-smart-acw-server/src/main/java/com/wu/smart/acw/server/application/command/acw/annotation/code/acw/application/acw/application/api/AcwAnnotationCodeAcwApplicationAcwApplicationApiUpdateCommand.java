...
@Schema(title = "acw_annotation_code_acw_application_acw_application_api_update_command",description = "")
public class AcwAnnotationCodeAcwApplicationAcwApplicationApiUpdateCommand {
