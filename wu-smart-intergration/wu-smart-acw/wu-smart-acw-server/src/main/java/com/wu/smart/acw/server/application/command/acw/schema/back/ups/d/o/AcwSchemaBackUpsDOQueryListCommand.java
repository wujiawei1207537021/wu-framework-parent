package com.wu.smart.acw.server.application.command.acw.schema.back.ups.d.o;
...
@Schema(title = "acw_schema_back_ups_d_o_query_List_command",description = "数据库备份信息")
public class AcwSchemaBackUpsDOQueryListCommand {
