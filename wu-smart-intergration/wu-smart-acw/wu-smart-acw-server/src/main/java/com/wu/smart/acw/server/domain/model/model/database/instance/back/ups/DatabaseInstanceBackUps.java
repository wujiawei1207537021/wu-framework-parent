package com.wu.smart.acw.server.domain.model.model.database.instance.back.ups;
...
@Schema(title = "database_instance_back_ups",description = "数据库备份信息")
public class DatabaseInstanceBackUps {
