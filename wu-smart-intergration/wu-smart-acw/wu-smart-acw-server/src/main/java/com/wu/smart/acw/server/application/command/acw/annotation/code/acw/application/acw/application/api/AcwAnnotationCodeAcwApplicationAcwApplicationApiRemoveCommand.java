...
@Schema(title = "acw_annotation_code_acw_application_acw_application_api_remove_command",description = "")
public class AcwAnnotationCodeAcwApplicationAcwApplicationApiRemoveCommand {
