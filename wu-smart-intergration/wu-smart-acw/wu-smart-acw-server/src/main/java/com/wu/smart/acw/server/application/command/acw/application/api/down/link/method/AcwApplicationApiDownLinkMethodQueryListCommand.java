...
@Schema(title = "acw_application_api_down_link_method_query_List_command",description = "ACW API 下联 Method 表")
public class AcwApplicationApiDownLinkMethodQueryListCommand {
