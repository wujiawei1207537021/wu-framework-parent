package com.wu.smart.acw.server.application.command.acw.table.column;
...
@Schema(title = "acw_table_column_query_List_command",description = "数据库表字段（即将弃用）")
public class AcwTableColumnQueryListCommand {
