package com.wu.smart.acw.server.domain.model.model.database.schema.back.ups;
...
@Schema(title = "database_schema_back_ups",description = "数据库备份信息")
public class DatabaseSchemaBackUps {
