...
import com.wu.framework.easy.mysql.binlog.listener.listener.MySQLBinlogListenerEndpointRegistry;
...
public class EasyMySQLBinlogListenerEndpointRegistrar implements ListenerEndpointRegistrar<MethodMySQLBinlogBinlogListenerEndpoint, MySQLBinlogConcurrentListenerContainerFactory> {
    ...
    public void setRegistry(MySQLBinlogListenerEndpointRegistry registry) {
     ...
     */
    @Override
    public void registerEndpoint(MethodMySQLBinlogBinlogListenerEndpoint endpoint, MySQLBinlogConcurrentListenerContainerFactory factory) {
