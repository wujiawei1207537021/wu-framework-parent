...
import com.wu.framework.easy.redis.listener.RedisConcurrentMessageListenerContainer;
...
public class RedisConcurrentListenerContainerFactory<K, V> implements
        ConcurrentListenerContainerFactory<RedisConcurrentMessageListenerContainer<K, V>, MethodRedisListenerEndpoint, K, V> {
    ...
    public RedisConcurrentMessageListenerContainer<K, V> createListenerContainer(MethodRedisListenerEndpoint endpoint) {
        ...
        final RedisConcurrentMessageListenerContainer<K, V> container = new RedisConcurrentMessageListenerContainer<K, V>();
        container.setConcurrency(endpoint.getConcurrency());
        container.setEndpoint(endpoint);
        container.setRedisProperties(beanFactory.getBean(RedisProperties.class));
        return container;
    }
