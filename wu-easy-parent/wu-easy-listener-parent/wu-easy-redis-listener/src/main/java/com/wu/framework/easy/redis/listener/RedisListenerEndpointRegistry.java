...
public class RedisListenerEndpointRegistry implements ListenerContainerRegistry<MethodRedisListenerEndpoint, RedisConcurrentListenerContainerFactory> {
     ...
     */
    @Override
    public void registerListenerContainer(MethodRedisListenerEndpoint endpoint, RedisConcurrentListenerContainerFactory factory, boolean startImmediately) {
    ...
    protected MessageListenerContainer createListenerContainer(MethodRedisListenerEndpoint endpoint, RedisConcurrentListenerContainerFactory factory) {
