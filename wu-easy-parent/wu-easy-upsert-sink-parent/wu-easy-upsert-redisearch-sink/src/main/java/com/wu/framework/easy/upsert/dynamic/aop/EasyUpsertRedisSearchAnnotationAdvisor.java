 ...
 */
public class EasyUpsertRedisSearchAnnotationAdvisor extends AbstractPointcutEasyUpsertAnnotationAdvisor {

    private final LazyRedisTemplate lazyRedisTemplate;

    public EasyUpsertRedisSearchAnnotationAdvisor(LazyRedisTemplate lazyRedisTemplate) {
    ...
    public Class<? extends Annotation> getAnnotationClass() {
        return EasyUpsertRedisSearch.class;
    }
}
