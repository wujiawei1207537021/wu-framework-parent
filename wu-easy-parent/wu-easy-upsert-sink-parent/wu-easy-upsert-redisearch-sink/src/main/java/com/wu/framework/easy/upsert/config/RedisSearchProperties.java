 ...
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = "spring.data.redis.search")
public class RedisSearchProperties {
    ...
    /**
     * Connection URL. Overrides getHost, getPort, and password. User is ignored. Example:
     * redis://user:password@example.com:6379
     */
    private String url;
    /**
     * Redis server getHost.
     */
    ...
    public static class Cluster {
        ...
        /**
         * Comma-separated list of "getHost:getPort" pairs to bootstrap from. This represents an
    ...
    public static class Sentinel {
        ...
        /**
         * Comma-separated list of "getHost:getPort" pairs.
         */
        private List<String> nodes;
