...
import com.wu.framework.authorization.exceptions.ExtractScopeException;
...
public class DefaultJwtAccessTokenConverter implements JwtAccessTokenConverter {
    ...
    public DefaultJwtAccessTokenConverter(AuthorizationProperties authorizationProperties) {
...
//        AuthorizationUser userDetails = new AuthorizationUser();
...
//
//        System.out.println(defaultJwtAccessTokenConverter.decryptNameForT(ss, "user", AuthorizationUser.class));
//
//        System.out.println(((Claim) map1.get("user")).as(AuthorizationUser.class));
//    }
     ...
     * @return
     */
    public AuthorizationProperties getShiroProperties() {
