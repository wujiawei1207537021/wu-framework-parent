package com.wu.freamwork.translation.convert;
 ...
 */
@Component
public class UserTranslationAdvancedTarget extends TranslationAdvancedTarget {
    public UserTranslationAdvancedTarget(List<TranslationAPI> translationAPIList) {
