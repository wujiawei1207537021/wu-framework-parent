package com.wu.framework.tts.server.platform.starter.application.command.tts.chinese.characters;
...
@Schema(title = "tts_chinese_characters_query_List_command",description = "tts 中文")
public class TtsChineseCharactersQueryListCommand {
