...
@Schema(title = "menu_tree_dto", description = "")
public class MenuTreeDTO {
     ...
     */
    @ConvertField(convertItem = "MENU_IFRAME_TYPE")
     ...
     */
    @ConvertField(convertItem = "MENU_TYPE")
    @Schema(description = "菜单type（0:目录 1：菜单 2：按钮）", name = "type")
    private Integer type;


    @Schema(description = "菜单type（目录 菜单 按钮）")
    ...
    @ConvertFieldBean
    private List<MenuTreeDTO> buttonList;
