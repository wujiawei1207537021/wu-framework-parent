package com.wu.framework.authorization.platform.convert;

import com.wu.framework.authorization.platform.rpc.DictionConvertApiRpc;
...
public class ResultDefaultLazyDictionaryConvert extends DefaultLazyDictionaryConvert {
    public ResultDefaultLazyDictionaryConvert(DictionConvertApiRpc dictionConvertApiRpc) {
        super(dictionConvertApiRpc);
    }
