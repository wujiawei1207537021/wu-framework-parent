...
public @interface ApiResponse {
     ...
     */
//    @AliasFor(annotation = io.swagger.v3.oas.annotations.responses.ApiResponse.class,attribute = "responseCode")
    int code();

    /**
     * Human-readable message to accompany the response.
     */
//    @AliasFor(annotation = io.swagger.v3.oas.annotations.responses.ApiResponse.class,attribute = "description")
    String message();
