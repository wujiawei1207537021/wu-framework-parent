...
import com.wu.framework.inner.layer.version.LazyVersion;
import com.wu.framework.inner.lazy.database.expand.database.persistence.cure.CureAdapter;
import com.wu.framework.lazy.cure.mybatis.defaults.MybatisCureSqlSessionFactoryBuilder;
 ...
 * @since 2017-01-04
 */
public class MybatisCureSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    public MybatisCureSqlSessionFactoryBean(CureAdapter cureAdapter) {
     ...
     * SqlSession operations will doExecute SQL statements non-transactionally.
     *
...
//        SqlRunner.DEFAULT.close(); 3.5.1 版本后支持的
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        if (this.databaseIdProvider != null) {// fix #64 set databaseId before parse mapper xmls
            try {
                ...
                throw new RuntimeException("Failed getting a databaseId", e);
            }
        }
        ...
        if (xmlConfigBuilder != null) {
            try {
                ...
                throw new RuntimeException("Failed to parse config resource: " + this.configLocation, ex);
            } finally {
        ...
        final SqlSessionFactory sqlSessionFactory = new MybatisCureSqlSessionFactoryBuilder(cureAdapter).build(targetConfiguration);
        ...
        if (globalConfig.isBanner()) {
            ...
            System.out.println("   USE MYBATIS CURE  IN SAAS        " + LazyVersion.getVersion() + " ");
        }
